...
namespace VsEVM
{
    ...
    public sealed partial class VsEVMPackage : AsyncPackage, IVsSolutionEvents7, IVsSolutionEvents
    {
        #region Constructors
        static VsEVMPackage()
        {
            Runtime.Initialize("VsEVM", "VS");
        }
        #endregion
        ...
        private static async Task InstallBuildSystemAsync()
        {
            ...
            await Runtime.CopyFileAsync(Runtime.AssemblyLocation.CombinePath("VsEVM.SolidityProjectBuildTasks.dll"), Runtime.LocalAppDataDir.CombinePath("CustomProjectSystems", "Solidity", "Tools", "VsEVM.SolidityProjectBuildTasks.dll"));
        ...
        #region Fields
        public static VsEVMPackage Instance { get; private set; }
        #endregion
