...
namespace VsEVM.UI
{
    ...
    public class BlockchainExplorerToolWindow : ToolWindowPane
    {
        ...
        /// </summary>
        public BlockchainExplorerToolWindow() : base(VsEVMPackage.Instance)
        {
            this.Caption = "Blockchain Explorer";
            this.BitmapImageMoniker = KnownMonikers.NeuralNetwork;
            this.ToolBar = new CommandID(VsEVMPackageIds.BlockchainExplorerGuid, VsEVMPackageIds.BlockchainExplorerTWindowId);
