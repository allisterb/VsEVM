...
namespace VsEVM
{
    public class VSUtil : Runtime
    {
        ...
        {
            ThreadHelper.ThrowIfNotOnUIThread();
            VsShellUtilities.ShowMessageBox(VsEVMPackage.Instance, text, title ?? "StratisEVM error:",
        ...
        {
            ThreadHelper.ThrowIfNotOnUIThread();
            var dte = VsEVMPackage.Instance.GetService<EnvDTE.DTE, EnvDTE80.DTE2>();
            if (dte == null)
            {
        ...
        {
            ThreadHelper.ThrowIfNotOnUIThread();
            var dte = VsEVMPackage.Instance.GetService<DTE, EnvDTE80.DTE2>();
            if (dte == null)
            {
                ShowModalErrorDialogBox("Could not get DTE service.");
                return null;
        ...
        public IProjectLockService GetProjectLockService()
        {
            ...
            IComponentModel componentModel = VsEVMPackage.Instance.GetService<SComponentModel, IComponentModel>();
        ...
        {
            ThreadHelper.ThrowIfNotOnUIThread();
            var solutionService = VsEVMPackage.Instance.GetService<SVsSolution, IVsSolution>();
