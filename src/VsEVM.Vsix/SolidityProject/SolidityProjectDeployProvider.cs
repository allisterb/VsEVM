...
namespace VsEVM
{
    ...
    internal class SolidityProjectDeployProvider : IDeployProvider
    {
        ...
        {
            ToolWindowPane window = await VsEVMPackage.Instance.ShowToolWindowAsync(typeof(DeploySolidityProjectToolWindow), 0, true, VsEVMPackage.Instance.DisposalToken);
