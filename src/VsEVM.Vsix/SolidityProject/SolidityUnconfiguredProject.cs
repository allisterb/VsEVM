...
namespace VsEVM
{
    ...
    [ProjectTypeRegistration(ProjectTypeGuid, "Solidity", "#2", ProjectExtension, Language, resourcePackageGuid: VsEVMPackage.PackageGuidString, PossibleProjectExtensions = ProjectExtension, Capabilities = UniqueCapability)]
